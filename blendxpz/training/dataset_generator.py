...
survey = galcheat.get_survey(blendxpz_config["SURVEY_NAME"])

_DESCRIPTION = """
#Galaxies from COSMOS Extended catalog
"""
...
class ExCOSMOSDataset(tfds.core.GeneratorBasedBuilder):
    """Extended COSMOS galaxy dataset."""
...
def loadExCOSMOSDataset(
    ...
    """Load/Generate Extended COSMOS Dataset.
